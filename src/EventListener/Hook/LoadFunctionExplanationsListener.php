...
final class LoadFunctionExplanationsListener
{
    ...
    /**
     * Handle the PSR-14 load language file event.
     */
    public function __invoke(LoadLanguageFileEvent $event): void
    {
        $this->onLoadLanguageFile($event->getName(), $event->getLanguage());
    }
